...
export const translations = {
  es: {
    ...
    'contact.connect.title': 'También estoy acá',
    'contact.connect.text': 'Si preferís algo menos formal que un formulario:',
  ...
  en: {
    ...
    'contact.connect.title': 'You can also find me here',
    'contact.connect.text': 'If you prefer something less formal than a form:',
